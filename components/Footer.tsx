      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <h3 className="text-white text-2xl font-bold mb-4">Renova</h3>
            <p className="text-slate-400 mb-6 leading-relaxed text-sm">
              საიმედო სარემონტო კომპანია 10+ წლიანი გამოცდილებით. ვასრულებთ სრულ
              სარემონტო სამუშაოებს ხელშეკრულებით და გარანტიით.
            </p>
            ...
            <div className="mt-6 pt-6 border-t border-slate-700">
              ...
              <div className="flex gap-3">
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-slate-800 hover:bg-[#2563EB] rounded-lg flex items-center justify-center transition-colors duration-200"
                  aria-label="Facebook"
                >
                  <svg
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-slate-800 hover:bg-[#16A34A] rounded-lg flex items-center justify-center transition-colors duration-200"
                  aria-label="WhatsApp"
                >
                  <svg
                    className="w-5 h-5 text-white"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-slate-500 text-sm text-center md:text-left">
              © {new Date().getFullYear()} Renova. ყველა უფლება დაცულია.
            </p>
